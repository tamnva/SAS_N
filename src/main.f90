...
program main
  ...
  !$OMP  private(sas, age_rank_discharge, N0, Nleach, cQin, cQoutlet), &
  !$OMP& private(median_tt, median_rt, mean_rt, mean_tt, denitri_amount), &
  !$OMP& private(subNstore, j, max_age, max_old_fraction, cQout, meanTTD)
  ...
  do i = 1, size(alpha)
    ...
    !$OMP CRITICAL
    write(10, '(a6, i6, f15.5)') "iter =", i, rootMSE              !Model performance rmse
    write(11, '(a6, i6, 999f15.3)') "iter =", i, cQoutlet          !Simulated instream N-NO3
    write(12, '(a6, i6, 999f15.3)') "iter =", i, cQout             !Simulated instream N-NO3

    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%n_surplus(151:215)
    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%soil_N_store(151:215)
    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%soil_N_remove(151:215)
    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%soil_N_deni(151:215)
    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%soil_N_leach(151:215)
    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%sub_N_export(151:215)
    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%sub_N_store(151:215)
    write(13, '(a6, i6, 999f15.3)') "iter =", i, n_balance%sub_N_deni(151:215)

    write(14, '(a6, i6, 999f15.3)') "iter =", i, meanTTD/(sum(Qin(151:215)))   !mean TT from 1950-2014 (65 years)
    !$OMP END CRITICAL
